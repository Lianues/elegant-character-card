...
import { handleField, sanitizeFilename, stripDefaultEmptyFields, } from "./fieldHandlers.js";
/** 仓库根目录中默认裸图文件名 */
 ...
 */
async function copyProjectDocsTo(repoDir) {
 ...
 */
export async function repositorize(card, configPath = "config.yaml", sourceImagePath) {
    if (!card || !card.data) {
